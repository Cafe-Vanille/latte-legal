...
export default function Privacy(
	...
	return <div>
		...
		<p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection
			...
			of the <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator/" target="_blank">Free Privacy
		...
		<ul>
			...
			<li>
				<p><strong>Company</strong> (referred to as either &quot;the
					Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Latte.</p>
			</li>
			<li>
			...
			<li>
				<p><strong>Website</strong> refers to Latte, accessible from <a href="https://latte.cafe-vanille.com"
				                                                                rel="external nofollow noopener"
				                                                                target="_blank">https://latte.cafe-vanille.com</a>
				</p>
			</li>
			<li>
		...
		<ul>
			<li>By email: support@cafe-vanille.com</li>
		</ul>
	</div>;
}